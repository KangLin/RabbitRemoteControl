...
It uses libssh: https://www.libssh.org .</source>
        <translation>安全外壳（SSH）：是一种安全协议，也是安全管理远程服务器的最常见方法。SSH 使用多种加密技术，提供了一种机制，用于在两方之间建立加密安全连接，对每一方进行身份验证，以及来回传递命令和输出。你能远程执行程序、传输文件。它使用 libssh: https://www.libssh.org </translation>
    </message>
</context>
</TS>
