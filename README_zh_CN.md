...
+ 当前版本：
  - Windows: 支持 WINDOWS 7 及以后版本
    + 安装包：[RabbitRemoteControl_setup_v0.0.13.exe](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.13/RabbitRemoteControl_setup_v0.0.13.exe)
    + 绿色版本：[RabbitRemoteControl_v0.0.13.zip](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.13/RabbitRemoteControl_windows_v0.0.13.zip)
  - Ubuntu:
