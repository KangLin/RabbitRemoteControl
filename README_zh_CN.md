...
- Windows: 支持 WINDOWS 7 及以后版本
  + 安装包：[RabbitRemoteControl-Setup-v0.0.6.exe](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.6/RabbitRemoteControl-Setup-v0.0.6.exe)
  + 绿色版本：[RabbitRemoteControl_v0.0.6.zip](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.6/RabbitRemoteControl_v0.0.6.zip)
- Ubuntu:
