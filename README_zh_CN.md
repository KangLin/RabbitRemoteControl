...
- Windows: 支持 WINDOWS 7 及以后版本
  + 安装包：[RabbitRemoteControl-Setup-v0.0.5.exe](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.5/RabbitRemoteControl-Setup-v0.0.5.exe)
  + 绿色版本：[RabbitRemoteControl_v0.0.5.zip](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.5/RabbitRemoteControl_v0.0.5.zip)
- Ubuntu:
