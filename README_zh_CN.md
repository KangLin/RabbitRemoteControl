...
+ 当前版本：
  - Windows: 支持 WINDOWS 7 及以后版本
    + 安装包：[RabbitRemoteControl_setup_v0.0.17-24-ge350ac65.exe](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.17-24-ge350ac65/RabbitRemoteControl_setup_v0.0.17-24-ge350ac65.exe)
    + 绿色版本：[RabbitRemoteControl_v0.0.17-24-ge350ac65.zip](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.17-24-ge350ac65/RabbitRemoteControl_windows_v0.0.17-24-ge350ac65.zip)
  - Ubuntu:
