...
- Windows: 扩展名为 .exe
  - 架构:
    - win64:
      - 安装包：RabbitRemoteControl_v0.0.37_win64_msvc2022_64_qt6.9.0_Setup.exe
        - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_v0.0.37_win64_msvc2022_64_qt6.9.0_Setup.exe)
        - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_v0.0.37_win64_msvc2022_64_qt6.9.0_Setup.exe)
      - 便携包：RabbitRemoteControl_v0.0.37_win64_msvc2022_64_qt6.9.0_Portable.zip  
        如果系统没有安装 npcap ，安装程序位于：RabbitRemoteControl\bin\npcap-1.80.exe
        - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_v0.0.37_win64_msvc2022_64_qt6.9.0_Portable.zip)
        - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_v0.0.37_win64_msvc2022_64_qt6.9.0_Portable.zip)
    - win32: RabbitRemoteControl_v0.0.37_win32_msvc2017_qt5.12.12_Setup.exe
      - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_v0.0.37_win32_msvc2017_qt5.12.12_Setup.exe)
      - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_v0.0.37_win32_msvc2017_qt5.12.12_Setup.exe)
- Linux:
  - AppImage 包：扩展名为 .AppImage ，用于所有 Linux 系统
    - 架构:
      - x86_64: RabbitRemoteControl_0.0.37_Linux_x86_64.AppImage
        - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_0.0.37_Linux_x86_64.AppImage)
        - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_0.0.37_Linux_x86_64.AppImage)
      ...
      - aarch64: RabbitRemoteControl_0.0.37_Linux_aarch64.AppImage
          - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_0.0.37_Linux_aarch64.AppImage)
          - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_0.0.37_Linux_aarch64.AppImage)
  ...
  - Flatpak 包：扩展名为 .flatpak ，用于所有支持 Flatpak 的 Linux 系统。Fedora 默认使用此安装包。
    ...
    - 架构:
      - x86_64: RabbitRemoteControl_v0.0.37_Linux_x86_64.flatpak
        - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_v0.0.37_Linux_x86_64.flatpak)
        - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_v0.0.37_Linux_x86_64.flatpak)
      ...
      - aarch64: RabbitRemoteControl_v0.0.37_Linux_aarch64.flatpak
        - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_v0.0.37_Linux_aarch64.flatpak)
        - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_v0.0.37_Linux_aarch64.flatpak)
  - deb 包：扩展名为 .deb ，用于 Debian、Ubuntu 等
    - 架构:
      - amd64: rabbitremotecontrol_0.0.37_ubuntu-24.04_amd64.deb
        - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/rabbitremotecontrol_0.0.37_ubuntu-24.04_amd64.deb)
        - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/rabbitremotecontrol_0.0.37_ubuntu-24.04_amd64.deb)
      ...
      - arm64: rabbitremotecontrol_0.0.37_ubuntu-24.04-arm_arm64.deb
        - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/rabbitremotecontrol_0.0.37_ubuntu-24.04-arm_arm64.deb)
        - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/rabbitremotecontrol_0.0.37_ubuntu-24.04-arm_arm64.deb)
  - rpm 包：扩展名为 .rpm ，用于 RedHat、Fedora、CentOS 等
    - 架构:
      - x86_64: rabbitremotecontrol-0.0.37-1.fc41.x86_64.rpm
        - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/rabbitremotecontrol-0.0.37-1.fc41.x86_64.rpm)
        - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/rabbitremotecontrol-0.0.37-1.fc41.x86_64.rpm)
      ...
      - aarch64: rabbitremotecontrol-0.0.37-1.fc41.aarch64.rpm
        - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/rabbitremotecontrol-0.0.37-1.fc41.aarch64.rpm)
        - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/rabbitremotecontrol-0.0.37-1.fc41.aarch64.rpm)
- Android: 扩展名为 .apk
  - 架构:
    - arm64_v8a: RabbitRemoteControl_v0.0.37_android_arm64_v8a_qt6.9.0_Release.apk
      - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_v0.0.37_android_arm64_v8a_qt6.9.0_Release.apk)
      - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_v0.0.37_android_arm64_v8a_qt6.9.0_Release.apk)
    - x86_64: RabbitRemoteControl_v0.0.37_android_x86_64_qt6.9.0_Release.apk
      - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_v0.0.37_android_x86_64_qt6.9.0_Release.apk)
      - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_v0.0.37_android_x86_64_qt6.9.0_Release.apk)
- 苹果操作系统: RabbitRemoteControl_v0.0.37_macos.zip
  由于没有相关设备，所以没有进行测试。希望有兴趣的朋友参与开发和测试。
  - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_v0.0.37_macos.zip)
  - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_v0.0.37_macos.zip)
- 开发文档：RabbitRemoteControl_v0.0.37_document.zip
  - [从　github　下载](https://github.com/KangLin/RabbitRemoteControl/releases/download/v0.0.37/RabbitRemoteControl_v0.0.37_document.zip)
  - [从　sourceforge 下载](https://sourceforge.net/projects/rabbitremotecontrol/files/v0.0.37/RabbitRemoteControl_v0.0.37_document.zip)

## [开发](docs/Doxygen/Develop_zh_CN.md)

### 在线开发文档
- [sourceforge](https://rabbitremotecontrol.sourceforge.io/v0.0.37/Chinese/html/index.html)
