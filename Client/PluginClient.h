 ...
 *  - 阻塞模型： CPluginClient 与 CConnecterThread 一起使用，用于连接是阻塞模型的。
 *  - 非阻塞模型：CPluginClientThread 与 CConnecterConnect
 ...
 *  - no-blocking model: CPluginClientThread with CConnecterConnect
